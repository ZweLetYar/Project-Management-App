...
function page() {
  return (
    <div className="flex h-screen">
      <div className="w-1/2 bg-[#f7e7ce]  flex justify-center items-center gap-10 flex-col p-20">
      ...
      <div className=" bg-[#77a8a8] flex flex-col gap-4 items-center justify-center w-1/2  text-lg ">
        <LoginForm />
        <AuthForm />
      </div>
    </div>
